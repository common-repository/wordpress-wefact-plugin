			...
			<table class="widefat fixed" cellspacing="0">
				...
				<tbody>
					...
					<tr class="bold">
						...
						<td><?php echo WPWF::price($pricequote['AmountExcl']) ?></td>
					</tr>
					<tr>
						<td colspan="5"></td>
						<td><?php _e('Total', 'wp_wefact') ?> <?php _e('VAT', 'wp_wefact') ?></td>
						<td><?php echo WPWF::price($pricequote['AmountIncl'] - $pricequote['AmountExcl']) ?></td>
					</tr>
					<tr>
						<td colspan="5"></td>
						<td><?php _e('Total excl. VAT', 'wp_wefact') ?></td>
						<td><?php echo WPWF::price($pricequote['AmountIncl']) ?></td>
					</tr>
				</tbody>
			</table>
		</div>
